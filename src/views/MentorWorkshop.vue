<template>
  ...
  <main class="max-w-screen-xl mx-auto">
    <div class="my-16 px-4" v-if="workshops.length===0">
      <h3 style="color:rgb(228, 96, 228); font-size:40px; text-align:center; font-weight:bold">Chưa có Workshop bạn được làm diễn giả!</h3>
    </div>
...
import { getMentorWorkshops } from "../services/WorkshopService.js";
